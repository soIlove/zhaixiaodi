...
<div class="shop-banner"> <a href="javascript:;" class="log-in">立即登录</a>
  <div class="com-w">
    <div class="shop-word">
      <h3>宅小递联盟</h3>
      <p><span>电商导流，首选宅小递</span><br>
			        你想每天坐等更多的客人上门消费吗？<br>
			        你想帮亲们代收快递包裹赚钱吗？  <br>
			        加入宅小递联盟，月赚3000更轻松！</p>
      <a href="http://www.shouhuobao.com/merchant/merchant/disp-merchant-add.html">加入我们</a> </div>
    <div class="login-form">
      <div class="login-bg"></div>
     <form method="post" id="loginForm" action="/merchant/account/ajaxLogin.an">
        <h3>登录商户中心</h3>
        <div class="bh-item">
          <input id="j_username" name="j_username" placeholder="用户名/手机号/邮箱" type="text">
        </div>
        <div class="bh-item">
...
<div class="shop-intro">
  <div class="com-w">
    ...
    <p style="line-height:240%;font-size:16px;">2011年4月，宅小递在北京从第三方代收货平台开始做起；<br>2013年，宅小递的服务已经覆盖北京、上海、广州、深圳四个城市，网点不断增长，用户迅速翻倍，社区物流与生活服务平台初见雏形；
    <br>2014年6月，正式成立宅小递联盟，我们为盟友量身打造全方位发展服务计划，
让商户“赚钱更轻松，生意更省心，生活更有尊严”，<br>
逐步完善社区服务生态链，更好的为用户服务。
    </p>
  </div>
</div>
<div class="five-price">
  <div class="com-w">
    ...
    <img src="image/service-1.png" style="width:991px;height:auto;margin:15px auto;display:block;padding-bottom:35px;">
  </div>
</div>
...
<div class="three-join">
  <div class="com-w">
    ...
    <div class="three-joins">
    	<dl>
    		<dt><img src="image/join1.png"></dt>
    		<dd><span>店面位置</span>一线城市住宅社区一层</dd>
    	</dl>
    	<dl>
    		<dt><img src="image/join2.png"></dt>
    		<dd><span>店铺类别</span>便利店、洗衣店、3C数码店等 </dd>
    	</dl>
    	<dl>
    		<dt><img src="image/join3.png"></dt>
    		<dd><span>服务口碑</span>诚信亲民，无邻里投诉</dd>
    	</dl>
    </div>
  </div>
</div>
<div class="cooperative cooperative1 bh-posRlt">
  <div class="com-w">
    ...
    <img src="image/cost-1.png" style="margin:15px auto;display:block;">
    <!-- <div class="coop-wrap">
  ...
  <div class="com-w">
   ...
   <!-- <div class="pad-help"> <a href="http://www.shouhuobao.com/index!introduction.html">宅小递简介</a> <a href="http://www.shouhuobao.com/index!service.html">什么是代收货服务</a> <a href="http://www.shouhuobao.com/index!cooperation.html">对外合作</a> <a href="http://www.shouhuobao.com/index!join.html">网点加盟</a> </div> -->
    <div class="copyRight bh-overf">
      <p> <span>Copyright?2011-2015 Shouhuobao.com 版权所有</span><span class="copyright-icp">京ICP证110890号   京ICP备11018594号-1<b>京公网安备编号：110105013415</b></span> <span class="copyAddress">公司地址：北京市朝阳区小关北里甲2号渔阳置业大厦B403室</span> </p>
      <img src="image/copyRight.jpg" class="bh-fr"> </div>
  </div>
</div>
<div class="back"><a href="#logo"></a></div>
<script>
...
var ln = $('.coop-wrap ul:first li').length
				var s = {
					...
					appTo : function(k, l) {
						...
						for (var i = 0; i < ln; i++) {
							if (i >= k && i <= l) {
								$('.coop-wrap ul:first li').eq(i).clone().appendTo(ul);
							}
						}
				...
				function addtab() {
					if (tabl !== 1) {
						for (var j = 0; j < tabl; j++) {
							if (j == 0) {
								$('div.Bslidetabs').append(s.span.clone().addClass('current'));
							} else {
				...
				function prev() {
					if (s.b) {
						...
						$('.Bslidetabs span').removeClass('current').eq(s.i).addClass('current');
					}
				}
                ...
                $('div.Bslidetabs span').live('click',function(){
					...
					setTimeout(function() {
						...
						if (s.w <= 650) {
							if ($('.autoDiv ul').length === 1) {
								...
								$('.createUl').show();
								s.ul.hide();
								$('.createUl').attr('class', $('.createUl').attr('class').replace('w501', 'w320'));
							}
							s.b = true;
							s.px = true;
							...
							if ($('.autoDiv ul').length === 1) {
								...
								$('.createUl').show();
								s.ul.hide();
								$('.createUl').attr('class', $('.createUl').attr('class').replace('w320', 'w501'));
							}
							s.b = true;
							s.px = true;
						} else if (s.w > 970) {
